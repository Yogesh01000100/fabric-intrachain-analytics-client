...
CORE_PEER_ADDRESS=localhost:8001
...
set -x
peer channel fetch config config_block.pb -o localhost:8000 -c $CHANNEL_NAME --tls --cafile $ORDERER_CA
...
CORE_PEER_ADDRESS=localhost:8000
CORE_PEER_LOCALMSPID=OrdererMSP

peer channel update -f final_update_in_envelope.pb -c $CHANNEL_NAME -o localhost:8000 --tls --cafile $ORDERER_CA
