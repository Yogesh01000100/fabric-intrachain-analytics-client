...
let count = 0; //counter
// API endpoints to retrieve hospital data
app.get('/getHospitalRole10', cacheMiddleware(5), async (req, res) => {
...
app.get('/getHospitalRole20', cacheMiddleware(5), async (req, res) => {
	const userId = req.userId;
	const gateway = gateways[userId];
...
app.get('/getHospitalRole30', cacheMiddleware(5), async (req, res) => {
	const userId = req.userId;
	console.log(gateways[userId]);
	const gateway = gateways[userId];
